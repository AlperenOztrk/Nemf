package com.wiuma.nemf.ui.ViewHolders.NewShopsDetail;
...
public class NewShopsDetailViewHolder extends RecyclerView.ViewHolder {
    ImageView logo, image;
    TextView logoText, storeName, storeDescription, productCount;

    public NewShopsDetailViewHolder(@NonNull View itemView) {
        super(itemView);
